 ...
 * {@link com.dheeraj.auctionapp.ui.LoginFragment.OnLoginFragmentInteractionListener} interface
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(TextUtils.equals(mUserName.getText(), "dheeraj") && TextUtils.equals(mPassword.getText(), "1234")){
                    if (mListener != null) {
